...
int main(int argc, char* argv[]) {
  ...
  cout << "attempt to allocate " << sizeof(graph_node_t) * NWARPS_TOTAL * MAX_SLOT_NUM * UNROLL * GRAPH_DEGREE / 1024.0 / 1024 / 1024 << " GB" << endl;
  ...
  if(!LABELED) {
    printf("Symmetry breaking is used. PatternMultiplicity=%d\n", p.PatternMultiplicity);
